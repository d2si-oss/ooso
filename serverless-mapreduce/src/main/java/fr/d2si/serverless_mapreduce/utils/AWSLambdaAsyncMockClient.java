...
public class AWSLambdaAsyncMockClient implements AWSLambda {
    ...
    public AWSLambdaAsyncMockClient() {
        ...
        lambdaHandlerMapping.put("mappers_driver", "fr.d2si.serverless_mapreduce.mappers_driver.MappersDriver");
        lambdaHandlerMapping.put("reducers_driver", "fr.d2si.serverless_mapreduce.reducers_driver.ReducersDriver");
        lambdaHandlerMapping.put("mapper", "fr.d2si.serverless_mapreduce.mapper_wrapper.MapperWrapper");
        lambdaHandlerMapping.put("reducer", "fr.d2si.serverless_mapreduce.reducer_wrapper.ReducerWrapper");
        lambdaHandlerMapping.put("reducers_listener", "fr.d2si.serverless_mapreduce.reducers_listener.ReducersListener");
        lambdaHandlerMapping.put("mappers_listener", "fr.d2si.serverless_mapreduce.mappers_listener.MappersListener");
    }
